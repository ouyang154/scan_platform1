          ...
          <div class="setting-drawer-index-blockChecbox">
            <a-tooltip>
              ...
              <div class="setting-drawer-index-item" @click="handleMenuTheme('dark')">
                <img src="images/LCkqqYNmvBEbokSDscrm.svg" alt="dark">
            ...
            <a-tooltip>
              ...
              <div class="setting-drawer-index-item" @click="handleMenuTheme('light')">
                <img src="images/jpRkZQMyYRryryPNtyIC.svg" alt="light">
                <div class="setting-drawer-index-selectIcon" v-if="navTheme !== 'dark'">
                  <a-icon type="check"/>
                </div>
              </div>
          ...
          <div class="setting-drawer-index-blockChecbox">
            <a-tooltip>
              ...
              <div class="setting-drawer-index-item" @click="handleLayout('sidemenu')">
                <img src="images/JopDzEhOqwOjeNTXkoje.svg" alt="sidemenu">
            ...
            <a-tooltip>
              ...
              <div class="setting-drawer-index-item" @click="handleLayout('topmenu')">
                <img src="images/KDNDBbriJhLwuqMoxcAr.svg" alt="topmenu">
                <div class="setting-drawer-index-selectIcon" v-if="layoutMode !== 'sidemenu'">
                  <a-icon type="check"/>
                </div>
              </div>
